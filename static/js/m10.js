function create () 
{
    ...
    var text = document.createTextNode("Server request sent, wait for response...");       
    el.appendChild(text);                                
    document.getElementsByClassName('block')[0].appendChild(el);  
}
function create_second_block () 
{
    var el = document.createElement("p");        
    var text = document.createTextNode("Server request sent, wait for response...");       
    el.appendChild(text);                                
    document.getElementsByClassName('block')[1].appendChild(el);  
}
